...
> **⚠️ SUPERSEDED (2026-07): digcit is now fully OPEN.** All 18 activities are
> free and public; there is no paywall, placeholder, or auth gateway in the live
> build. `scripts/build-pages.js` publishes everything. The free/paid design below
> is retained only as a reference in case a licensed tier is reintroduced later.
