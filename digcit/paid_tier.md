...
> **⚠️ NOT CURRENTLY IN USE (2026-07).** digcit is fully **open** — every activity
> is free and public, so no access needs to be granted. This guide is kept only for
> reference in case a paid/licensed tier is reintroduced later.
