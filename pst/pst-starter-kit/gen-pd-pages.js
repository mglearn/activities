...
const SUITES = {
  ...
  // NOTE: pst moved OUT of activities/ (now /pst at repo root). Its PD pages (udl/elps/guide)
  // are hand-maintained under ../pst/ with ../ctobs/assets/ paths and are NOT generated here.
};
