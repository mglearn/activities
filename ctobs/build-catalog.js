...
/* build-catalog.js — scan all breakout suites and emit catalog.js (window.CATALOG),
   powering the top-level activities/index.html (search + randomizer).
   Run:  node activities/build-catalog.js */
...
const SUITES = [
  ...
  { id: 'relic-rooms', name: 'Relic Rooms', accent: '#5b3fa5',
    desc: 'Self-contained, seven-language investigation activities where students examine nine mystery exhibits in three steps — identify, understand, connect. Aligned to the Texas Essential Knowledge and Skills.',
