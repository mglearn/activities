...
1. **Copy `relic-rooms/tvc/` to your new activity folder.** (For a breakout under
   `activities/`, load the shared `../assets/i18n.js` instead of bundling a local
...
Every breakout in `activities/` shares one small i18n engine at
`activities/assets/i18n.js`. It provides a 7-language `<select>` switcher
