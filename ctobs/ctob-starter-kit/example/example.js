/* Auto-generated by build-translations.js — do not edit by hand.
   Edit example.en.js (English) and _i18n/<lang>.json (translations), then rebuild. */
window.BREAKOUT = {
  ...
  "UI": {
    ...
    "es": {
      ...
      "footer.disclaimer": "Ejemplo de plantilla incluido en el CTOB Starter Kit. Contenido CC BY-NC 4.0.",
      ...
      "clues": [
        {
          ...
          "body": "The Sun heats water in oceans, lakes, and rivers."
        },
        {
          "id": "c2",
          "ico": "💨",
          "nm": "Evaporation",
          "title": "Water rises",
          "body": "Heated water turns into an invisible gas called water vapor and rises into the air."
        },
        {
          "id": "c3",
          "ico": "☁️",
          "nm": "Condensation",
          "title": "Clouds form",
          "body": "High up where the air is cold, water vapor cools into tiny droplets that gather into clouds."
        },
        {
          "id": "c4",
          "ico": "🌧️",
          "nm": "Precipitation",
          "title": "Water falls",
          "body": "When the droplets join and grow heavy, they fall as rain, snow, sleet, or hail."
        },
        {
          "id": "c5",
          "ico": "🏞️",
          ...
          "body": "Fallen water collects in oceans, lakes, and the ground — and the cycle begins again."
        },
        {
          "id": "c6",
          "ico": "🦎",
          "nm": "Desert Lizard",
          "title": "A thirsty-looking fact",
          "body": "Some desert lizards can live their whole lives without ever drinking liquid water."
        }
      ],
      "locks": [
        {
          ...
          "q": "Put the four steps of the water cycle in order, starting after the Sun heats the water.",
          "pads": [
            {
              "k": "collect",
              "e": "🏞️ Collection",
        ...
        },
        {
          ...
          "type": "mc",
          "color": "#1aa3b8",
          "title": "What makes vapor rise?",
          "q": "According to the clues, what makes water rise into the air as vapor?",
          "options": [
            "It gets heavier than air",
            "The Sun's heat",
            "It freezes solid"
          ],
          "answerIndex": 1,
        ...
        },
        {
          ...
          "type": "multi",
          "color": "#46a23c",
          "title": "Sort the strong evidence",
          "q": "Check ONLY the statements that help explain the water cycle. Leave out the true-but-off-topic one.",
          "items": [
            {
              "t": "The Sun heats water so it evaporates.",
              "strong": true
            },
            {
              "t": "Vapor cools high up and condenses into clouds.",
              "strong": true
            },
            {
              "t": "Heavy droplets fall as rain or snow.",
              "strong": true
            },
            {
              "t": "Some desert lizards never drink water.",
              "strong": false
            }
          ],
        ...
        },
        {
          ...
          "q": "In one short phrase, what is this whole process called?",
          "answer": [
            "water cycle",
            "the water cycle"
          ],
      ...
      "clues": [
        {
          ...
          "ico": "☀️",
          "nm": "El calor del Sol",
          "title": "El calor del Sol",
          "body": "El Sol calienta el agua de los océanos, lagos y ríos."
        },
        {
          "id": "c2",
          "ico": "💨",
          "nm": "Evaporación",
          "title": "El agua sube",
          "body": "El agua caliente se convierte en un gas invisible llamado vapor de agua y sube al aire."
        },
        {
          "id": "c3",
          "ico": "☁️",
          "nm": "Condensación",
          "title": "Se forman nubes",
          "body": "Allá arriba, donde el aire es frío, el vapor se enfría en gotitas que se juntan en nubes."
        },
        {
          "id": "c4",
          "ico": "🌧️",
          "nm": "Precipitación",
          "title": "El agua cae",
          "body": "Cuando las gotitas se juntan y pesan, caen como lluvia, nieve, aguanieve o granizo."
        },
        {
          "id": "c5",
          "ico": "🏞️",
          "nm": "Acumulación",
          "title": "De vuelta al inicio",
          "body": "El agua caída se acumula en océanos, lagos y el suelo, y el ciclo vuelve a empezar."
        },
        {
          "id": "c6",
          "ico": "🦎",
          "nm": "Lagarto del desierto",
          "title": "Un dato que parece venir al caso",
          "body": "Algunos lagartos del desierto pueden vivir toda su vida sin beber agua líquida."
        }
      ],
      "locks": [
        {
          ...
          "type": "seq",
          "color": "#2f6fe0",
          "title": "Ordena el ciclo",
          "q": "Ordena los cuatro pasos del ciclo del agua, empezando después de que el Sol calienta el agua.",
          "pads": [
            {
              "k": "collect",
              "e": "🏞️ Acumulación",
        ...
        },
        {
          ...
          "type": "mc",
          "color": "#1aa3b8",
          "title": "¿Qué hace subir el vapor?",
          "q": "Según las pistas, ¿qué hace que el agua suba al aire como vapor?",
          "options": [
            "Se vuelve más pesada que el aire",
            "El calor del Sol",
            "Se congela"
          ],
          "answerIndex": 1,
        ...
        },
        {
          ...
          "type": "multi",
          "color": "#46a23c",
          "title": "Separa la evidencia fuerte",
          "q": "Marca SOLO las afirmaciones que ayudan a explicar el ciclo del agua. Deja fuera la que es verdadera pero no viene al caso.",
          "items": [
            {
              "t": "El Sol calienta el agua y esta se evapora.",
              "strong": true
            },
            {
              "t": "El vapor se enfría arriba y se condensa en nubes.",
              "strong": true
            },
            {
              "t": "Las gotas pesadas caen como lluvia o nieve.",
              "strong": true
            },
            {
              "t": "Algunos lagartos del desierto nunca beben agua.",
              "strong": false
            }
          ],
        ...
        },
        {
          ...
          "type": "word",
          "color": "#f0a316",
          "title": "Nombra el proceso",
          "q": "En una frase corta, ¿cómo se llama todo este proceso?",
          "answer": [
            "ciclo del agua",
            "el ciclo del agua",
            "water cycle",
