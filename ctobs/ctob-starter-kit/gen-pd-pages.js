...
// One entry per suite. The key must match a folder next to this script AND a
// top-level key in _pd/suite/*.json. Add your own suites here (theme + whether
// a policy.html exists in that folder). This kit ships one: "example".
const SUITES = {
  example: { accent: '#1aa3b8', accentD: '#12808f', navy: '#12406b', bandA: 'rgba(26,163,184,.10)', bandB: 'rgba(47,111,224,.08)', policy: false },
};
