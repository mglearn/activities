...
/* build-more.js — expand the "Bible as Literature" suite.
   ...
   Run:  node activities/bible/build-more.js */
const fs = require('fs');
const path = require('path');
const { COMMON } = require('../build-ml.js');

const ROOT = __dirname;                       // activities/bible
...
const CHROME = {
  es: { dir: 'ltr', htmlLang: 'es', navAll: 'Todas las actividades', bandWord: 'Grados', featured: '★ Destacada', openCTA: 'Abrir en español →',
    ...
    footer: 'Contenido CC BY-NC 4.0 · Código MIT · La Biblia como literatura · Se ejecuta en tu navegador, sin recopilar datos',
  ...
  vi: { dir: 'ltr', htmlLang: 'vi', navAll: 'Tất cả hoạt động', bandWord: 'Lớp', featured: '★ Nổi bật', openCTA: 'Mở bằng tiếng Việt →',
    ...
    footer: 'Nội dung CC BY-NC 4.0 · Mã nguồn MIT · Kinh Thánh như văn học · Chạy trong trình duyệt, không thu thập dữ liệu',
  ...
  ar: { dir: 'rtl', htmlLang: 'ar', navAll: 'جميع الأنشطة', bandWord: 'الصفوف', featured: '★ مميّزة', openCTA: 'افتح بالعربية ←',
    ...
    footer: 'المحتوى CC BY-NC 4.0 · الشيفرة MIT · الكتاب المقدس بوصفه أدبًا · يعمل في متصفحك دون جمع بيانات',
  ...
  hi: { dir: 'ltr', htmlLang: 'hi', navAll: 'सभी गतिविधियाँ', bandWord: 'कक्षा', featured: '★ विशेष', openCTA: 'हिन्दी में खोलें →',
    ...
    footer: 'सामग्री CC BY-NC 4.0 · कोड MIT · साहित्य के रूप में बाइबल · आपके ब्राउज़र में चलता है, कोई डेटा एकत्र नहीं',
  ...
  ur: { dir: 'rtl', htmlLang: 'ur', navAll: 'تمام سرگرمیاں', bandWord: 'جماعت', featured: '★ نمایاں', openCTA: 'اردو میں کھولیں ←',
    ...
    footer: 'مواد CC BY-NC 4.0 · کوڈ MIT · ادب کے طور پر بائبل · آپ کے براؤزر میں چلتا ہے، کوئی ڈیٹا جمع نہیں',
  ...
  zh: { dir: 'ltr', htmlLang: 'zh', navAll: '全部活动', bandWord: '年级', featured: '★ 精选', openCTA: '用中文打开 →',
    ...
    footer: '内容 CC BY-NC 4.0 · 代码 MIT · 作为文学的圣经 · 在你的浏览器中运行，不收集数据',
