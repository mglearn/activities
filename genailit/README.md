...
**Live:** https://mglearn.github.io/activities/genailit/ — all lessons + the
[🕹️ Critical Thinking Arcade](https://mglearn.github.io/activities/genailit/arcade/) (three
free, no-login sorting games, one per grade band, in 7 languages).

Sibling suite: [Digital Citizenship Breakouts](https://mglearn.github.io/activities/digcit/)
(same engine, Digital Citizenship TEKS strand).

## The activities

Each grade has a featured lesson and a full lesson — both free and open, in the
AI-adjacent TEKS strands. The through-line: *AI makes guesses from patterns, it can be
...
node scripts/build-pages.js      # -> _site/ (fully open; publishes all 18 activities)
```
